      ...
      <div className="flex-row md:flex gap-12 ">
        <div>
          <div className="space-y-2">
            ...
            <h1 className="text-5xl font-bold">
              Become a Contributor and enjoy program benefits
            </h1>
            <p className="font-medium text-base py-3">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Id
              doloremque deleniti debitis dolore, accusamus voluptate numquam.
              Voluptate reiciendis, quidem alias beatae voluptatem natus
              repellat pariatur id rerum suscipit eum perspiciatis rem officia
              voluptas animi ex amet.
            </p>
          </div>
          <div>
            <ul className="space-y-4">
              <li className="flex items-start justify-center gap-5">
                <div className="p-3 bg-red-100 rounded-full">
                  <div className="bg-yellow-500 p-1 rounded-full text-white">
                    <FaCheck />
                  </div>
                </div>
                <div>
                  ...
                  <p className="text-base font-medium">
                    Odio blandit convallis aliquet nibh potenti auctor primis
                    neque efficitur commodo porttitor
                  </p>
                </div>
              </li>
        ...
        <div>
          <img
            src={img}
            alt=""
            className="w-[2050px] h-full bg-cover bg-no-repeat bg-fixed mt-5 md:mt-0"
          />
        </div>
      </div>
    </section>
