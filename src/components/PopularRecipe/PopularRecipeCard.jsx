      ...
      <div className="px-4 py-8 shadow-lg max-w-[350px] font-sans rounded-xl space-y-6 my-20 mx-auto bg-white">
        <div className="flex justify-center w-full h-48 lg:h-[280px] relative">
          <div className="flex justify-between items-center left-4 right-4 top-4 absolute">
            ...
            <button className=" bg-primary hover:bg-primary/60  text-white duration-200 text-white font-medium px-3 py-1 rounded-xl flex items-center gap-2">
              <CiUser /> 30% off
            </button>
          </div>
          <img
            className="rounded-lg bg-black/40 w-full h-full"
            src={popularRecipe?.image_url}
            alt="card navigate ui"
          />
        </div>
        <div className="text-center w-[85%] mx-auto font-semibold space-y-2">
          <h6 className="text-sm md:text-base lg:text-lg">
            {popularRecipe?.chef_name}
          </h6>
